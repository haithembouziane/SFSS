...
const CropPrediction = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-green-50" style={{ backgroundImage: `url(${bgImage})` }}>
      <DashboardHeader />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-lg" style={{
                background: 'linear-gradient(135deg, #C4A574 0%, #B8956A 100%)',
                borderTop: '6px solid #D4B896',
                borderBottom: '3px solid #A08560'
              }}>
                ...
                <div className="p-6 relative z-10">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-white drop-shadow-md">Soil Type</h3>
                  </div>
                  <select 
                    value={formData.soilType}
                    onChange={(e) => handleInputChange('soilType', e.target.value)}
                    className="w-full px-4 py-3 rounded-xl bg-white/95 text-gray-800 font-medium focus:outline-none focus:ring-2 focus:ring-white/50 shadow-inner"
                  >
                    <option>Loam</option>
                    <option>Sandy</option>
                    <option>Clay</option>
                ...
                <div className="absolute bottom-0 left-0 right-0 h-2 bg-gradient-to-r from-transparent via-black/10 to-transparent"></div>
              </div>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-lg" style={{
                ...
                borderBottom: '3px solid #76502E'
              }}>
                <svg className="absolute top-0 left-0 right-0 w-full h-4" preserveAspectRatio="none" viewBox="0 0 1440 48">
                ...
                <div className="p-6 pt-8 relative z-10">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-white drop-shadow-md">Crop Type</h3>
                  </div>
                  <select 
                    value={formData.crop}
                ...
                <div className="absolute bottom-0 left-0 right-0 h-2 bg-gradient-to-r from-transparent via-black/15 to-transparent"></div>
              </div>

              {/* Rainfall Layer */}
              <div className="relative rounded-3xl overflow-hidden shadow-lg" style={{
                background: 'linear-gradient(135deg, #7A6A4A 0%, #5E5236 100%)',
                borderTop: '3px solid #8B7B5A',
                borderBottom: '3px solid #4D4229'
              }}>
                <svg className="absolute top-0 left-0 right-0 w-full h-4" preserveAspectRatio="none" viewBox="0 0 1440 48">
                ...
                <div className="p-6 pt-8 relative z-10">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-white drop-shadow-md">Annual Rainfall (mm)</h3>
                  </div>
                  <input 
                    type="number"
                    step="0.1"
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/95 text-gray-800 font-medium focus:outline-none focus:ring-2 focus:ring-white/50 shadow-inner placeholder:text-gray-500"
                  />
                </div>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-lg" style={{
                ...
                borderTop: '4px solid #7D8C4F',
                borderBottom: '4px solid #4A5A1E'
              }}>
                <svg className="absolute top-0 left-0 right-0 w-full h-5" preserveAspectRatio="none" viewBox="0 0 1440 48">
                ...
                <div className="p-6 pt-10 space-y-5 relative z-10">
                  <div>
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <h3 className="text-xl font-bold text-white drop-shadow-md">Fertilizer Applied</h3>
                    </div>
                    <select 
                  ...
                  <div>
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <h3 className="text-xl font-bold text-white drop-shadow-md">Irrigation System</h3>
                    </div>
                    <select 
                ...
                <div className="absolute bottom-0 left-0 right-0 h-3 bg-gradient-to-r from-transparent via-black/20 to-transparent"></div>
              </div>

              {/* Weather Conditions Layer */}
              <div className="relative rounded-3xl overflow-hidden shadow-lg" style={{
                background: 'linear-gradient(135deg, #5A6A4E 0%, #4A5A3E 100%)',
                borderTop: '3px solid #6B7A5E',
                borderBottom: '4px solid #3A4A2E'
              }}>
                <svg className="absolute top-0 left-0 right-0 w-full h-5" preserveAspectRatio="none" viewBox="0 0 1440 48">
                ...
                <div className="p-6 pt-9 relative z-10">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-white drop-shadow-md">Weather Conditions</h3>
                  </div>
                  <select 
                ...
                <div className="absolute bottom-0 left-0 right-0 h-3 bg-gradient-to-r from-transparent via-black/25 to-transparent"></div>
              </div>

              {/* Yield Input Layer - Bedrock */}
              <div className="relative rounded-3xl overflow-hidden shadow-xl" style={{
                background: 'linear-gradient(135deg, #4A5A3E 0%, #3A4A2E 100%)',
                borderTop: '4px solid #5A6A4E',
                borderBottom: '6px solid #2A3A1E'
              }}>
                <svg className="absolute top-0 left-0 right-0 w-full h-5" preserveAspectRatio="none" viewBox="0 0 1440 48">
                ...
                <div className="p-6 pt-9 relative z-10">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-white drop-shadow-md">Expected Yield (Tons/Hectare)</h3>
                  </div>
                  <input 
                    type="number"
                    step="0.01"
                ...
                <div className="absolute bottom-0 left-0 right-0 h-4 bg-gradient-to-r from-transparent via-black/30 to-transparent"></div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-4 rounded-2xl font-bold text-white text-lg shadow-xl transition-all duration-300 hover:shadow-2xl disabled:opacity-50 hover:scale-[1.02] relative overflow-hidden"
                style={{
